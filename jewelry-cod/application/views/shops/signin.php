                  ...
                  <div class="panel">
                      <div class="panel-body container-fluid">
                        ...
                        <div class="col-md-24">
                          ...
                          <label class="floating-label">Selecciona estado: </label>
                          <select id="estados_1" class="form-control round estados" name="id_estado" alt="1">
                            ...
                            <?php endforeach; ?>
                              ...
                              <div class=" col-md-12 example-wrap">
                                    <label class="floating-label">Selecciona Municipio: </label>
                                    <select id="municipios_1" class="form-control round municipios" name="id_municipios" alt="1"></select>
                              </div>
                        </div>
                      </div>
                        <div class="col-md-24">
                            ...
                            <div class="col-md-12 example-wrap">
                              <label>Ingresa horarios de la tienda.</label>
                                <input type="text" class="form-control" name="schedules" data-plugin="dropify" data-default-file="">
                          </div>
                          </div>
