											...
											<ul id="sandBox" class="list-unstyled">
												...
												<li class="element no_full_width" data-alpha="Donec condimentum fer" data-price="20000">
													<ul class="row-container list-unstyled clearfix">
														<li class="row-left">
														<a href="./product.html" class="container_item">
														<img src="./assets/images/demo_270x270.png" class="img-responsive" alt="Donec condimentum fer">
														</a>
														<div class="hbw">
															<span class="hoverBorderWrapper"></span>
														</div>
												...
												<li class="element no_full_width" data-alpha="Donec justo condimentum" data-price="20000">
													<ul class="row-container list-unstyled clearfix">
														<li class="row-left">
														<a href="./product.html" class="container_item">
														<img src="./assets/images/demo_270x270.png" class="img-responsive" alt="Donec justo condimentum">
														</a>
														<div class="hbw">
															<span class="hoverBorderWrapper"></span>
														</div>
												...
												<li class="element first no_full_width" data-alpha="Gravida est quis euismod" data-price="20000">
													<ul class="row-container list-unstyled clearfix">
														<li class="row-left">
														<a href="./product.html" class="container_item">
														<img src="./assets/images/demo_270x270.png" class="img-responsive" alt="Gravida est quis euismod">
														</a>
														<div class="hbw">
															<span class="hoverBorderWrapper"></span>
														</div>
												...
												<li class="element no_full_width" data-alpha="Malesuada fames ac ante" data-price="20000">
													<ul class="row-container list-unstyled clearfix">
														<li class="row-left">
														<a href="./product.html" class="container_item">
														<img src="./assets/images/demo_270x270.png" class="img-responsive" alt="Malesuada fames ac ante">
														</a>
														<div class="hbw">
															<span class="hoverBorderWrapper"></span>
														</div>
												...
												<li class="element first no_full_width" data-alpha="Curabitur cursus dignis" data-price="25900">
													<ul class="row-container list-unstyled clearfix">
														<li class="row-left">
														<a href="./product.html" class="container_item">
														<img src="./assets/images/demo_270x270.pngg" class="img-responsive" alt="Curabitur cursus dignis">
														<span class="sale_banner">
														<span class="sale_text">Sale</span>
														</span>
														</a>
