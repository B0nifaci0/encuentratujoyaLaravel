				...
				<ul class="list-inline">
					...
					<li class="umbrella hidden-xs">
						<div id="umbrella" class="list-inline unmargin">
							<div class="cart-link">
								<a class="dropdown-toggle dropdown-link" data-toggle="dropdown">
									<i class="sub-dropdown1"></i>
									<i class="sub-dropdown"></i>
					...
					<li class="mobile-search hidden-lg">
						<div class ="col-md-6 col-md-offset-3 hidden-md">
							<select  id="param_0" class=" col-md-12 form-control round" name="id_category" width="30%">
						...
						<div class="col-md-6 col-md-offset-1 hidden-md">
							<select id="estados_1" class="form-control round estados" name="id_estado" alt="0">
						...
						<div class="col-md-6 col-md-offset-1 hidden-md">
							<select id="municipios_0" name="municipality_id" class="form-control"></select>
							<form id="form_0" method="get" action="http://www.jewelrypalace.site/producto/buscar">
								<input type="hidden" id="param_hidden_0" name="id_municipality">
								<input type="hidden" id="param_hidden_01" name="id_category">
							</form>
						</div>
						<div class="col-md-6 col-md-offset-10 hidden-md">
								<input type="hidden" id="id_municipio_0" name="id_municipality">
								<button alt="0" type="submit" class="btn btn-lg search">Buscar</button>
						</div>
					</li>
				</ul>
			</div>
        ...
        <div id="content-wrapper">
			...
			<div class="home-slider-wrapper clearfix">
				<div class="camera_wrap" id="home-slider">
					<div data-src="{{{ url('dashboard-assets/assets/images/ch1.jpg')}}}">
						<div class="camera_caption camera_title_1 fadeIn">
						  <a style="color:#010101;"></a>
						</div>
          			...
          			<select id="municipios_1" name="municipality_id" class="form-control"></select>
										...
										<form id="form_1" method="get" action="/producto/buscar">
												<input type="hidden" id="param_hidden_1" name="id_municipality">
												<input type="hidden" id="param_hidden_11" name="id_category">
							...
							<div class="col-md-6 col-md-offset-9 visible-md visible-lg">
									<input type="hidden" id="id_municipio_1"  name="id_municipality">
									<div class="row">
						...
						<div data-src="{{{ url('dashboard-assets/assets/images/chi2.jpg')}}}">
            	<div class="camera_caption camera_title_2 fadeIn">
							...
							<div class="camera_caption camera_image-caption_2 moveFromLeft" style="visibility: hidden;">
									...
									<select id="municipios_2" name="municipality_id" class="form-control"></select>
										<form id="form_2" method="get" action="http://www.jewelrypalace.site/producto/buscar">
												<input type="hidden" id="param_hidden_2" name="id_municipality">
												<input type="hidden" id="param_hidden_21" name="id_category">
										</form>
									</div>
									<div class="col-md-6 col-md-offset-9 visible-md visible-lg">
											<input type="hidden" id="id_municipio_2" name="id_municipality">
					...
					<div data-src="{{{ url('dashboard-assets/assets/images/chi3.jpg')}}}">
            <div class="camera_caption camera_title_1 fadeIn">
              <a  style="color:#010101;"></a>
            </div>
            <div class="camera_caption camera_caption_1 fadeIn" style="color: rgb(1, 1, 1);">
              LA VIDA ES UNA FIESTA , VISTE PARA ELLA JEWERLY PALACE TE AYUDA
						...
						<div class="camera_caption camera_image-caption_3 moveFromLeft">
          					...
          					<select id="municipios_3" name="municipality_id" class="form-control"></select>
										...
										<form id="form_3" method="get" action="http://www.jewelrypalace.site/producto/buscar">
												<input type="hidden" id="param_hidden_3" name="id_municipality">
												<input type="hidden" id="param_hidden_31" name="id_category">
										</form>
                  </div>
						...
						<div class="camera_cta_1">
							...
							<div class="col-md-6 col-md-offset-10 visible-md visible-lg">
									...
									<button alt="3" type="submit" class="btn search">Buscar</button>
							</div>
						</div>
					</div>
				</div>
			...
			<script type="text/javascript">
				...
				$(".search").click(function(e){
					...
					$("#param_hidden_" + selector + "1").val(category);
									...
									@foreach($shops as $shop)
												<div class="home_collections_item">
													<div class="home_collections_item_inner">
														<div class="collection-details fondo img-container">
																@php
																	$image = route('images',"app/public/upload/shops/$shop->image")
																@endphp
															<a href="/productosdesucursal/{{$shop->id}}"><img width="270px" height="270px" src="{{ $image }}" class="img-responsive" alt="Donec aliquam ante non"></a>
													...
													<div class="element no_full_width col-md-8 col-sm-8 not-animated" data-animate="fadeInUp" data-delay="2">
																<ul class="row-container list-unstyled clearfix">
																	...
																	<a href="/product" class="container_item">
																		...
																		@endphp
																	<img width="375px" height="375px" src="{{ $image }}" class="img-responsive" alt="Donec aliquam ante non">
																	</a>
																	<div class="hbw">
																	...
																	<div class="hover-appear">
																		<form action="" method="post">
																			...
																			<div class="effect-ajax-cart">
																				...
																				<button class="select-option" type="button" onclick="window.location.href='/producto/{{{$product->id}}}'"><i class="fa fa-th-list" title="Select Options"></i><span class="list-mode">Select Option</span></button>
																			</div>
																		</form>
																		...
																		<a class="wish-list" title="wish list"><i class="fa fa-heart"></i><span class="list-mode">Add to Wishlist</span></a>
																	</div>
																	</li>
																</ul>
															</div>
						...
						<div class="home-banner-wrapper">
							<div class="container">
								<div id="home-banner" class="text-center clearfix">
									<img class="pulse img-banner-caption" src="{{{ url('dashboard-assets/assets/images/shops/an.png')}}}" alt="">
								...
								<div class="home-promotion-blog row">
									...
									<div class="home-bottom_banner_wrapper col-md-12">
										<div id="home-bottom_banner" class="home-bottom_banner">
											<a><img src="{{{ url('dashboard-assets/assets/images/marcas/l4-1.jpg')}}}" alt=""></a>
										</div>
									</div>
											...
											<div class="home-blog-item row">
												<div class="date col-md-4">
													<div class="date_inner">
														<p>
															<small>{{{$promotion->start_date}}}</small><small>{{{$promotion->expirition_date}}}</small>
														</p>
													</div>
												</div>
												<div class="home-blog-content col-md-20">
													<h4><a href="./article-left.html">{{{$promotion->name}}}</a></h4>
													<ul class="list-inline">
...
{{$promotion->description}}													</div>
										...
										<div id="partners-container" class="clearfix">
											...
											<div id="partners">
															<div class="logo text-center not-animated" data-animate="bounceIn" data-delay="150">
																<img class="pulse"src="{{{ url('dashboard-assets/assets/images/marcas/logo.png')}}}" alt="">
																</a>
															</div>
															<div class="logo text-center not-animated" data-animate="bounceIn" data-delay="150">

																<img class="pulse" src="{{{ url('dashboard-assets/assets/images/marcas/cartier.jpg')}}}" alt="">
																</a>
															</div>
															<div class="logo text-center not-animated" data-animate="bounceIn" data-delay="150">
																<img class="pulse" src="{{{ url('dashboard-assets/assets/images/marcas/images.jpg')}}}" alt="">
																</a>
															</div>
															<div class="logo text-center not-animated" data-animate="bounceIn" data-delay="150">
																<img class="pulse" src="{{{ url('dashboard-assets/assets/images/marcas/descarga.png')}}}" alt="">
																</a>
															</div>
															<div class="logo text-center not-animated" data-animate="bounceIn" data-delay="150">
																<img class="pulse" src="{{{ url('dashboard-assets/assets/images/marcas/ff.png')}}}" alt="">
																</a>
															</div>

															<div class="logo text-center not-animated" data-animate="bounceIn" data-delay="150">
																<img class="pulse" src="{{{ url('dashboard-assets/assets/images/marcas/jc.jpg')}}}" alt="">
																</a>
															</div>
															<div class="logo text-center not-animated" data-animate="bounceIn" data-delay="150">
																<img class="pulse" src="{{{ url('dashboard-assets/assets/images/marcas/b.png')}}}" alt="">
																</a>
															</div>
											</div>
										</div>
	...
	<script src="{{{url('dashboard-assets/assets/javascripts/cs.global.js')}}}" type="text/javascript"></script>
									...
									<div class="row">
										<div class="col-md-12 product-image">
											<div id="quick-shop-image" class="product-image-wrapper">
												...
												$image = route('images',"app/public/upload/products/$product->image")
												@endphp
												<a class="main-image"><img class="img-zoom img-responsive image-fly" src="{{ $image }}" data-zoom-image="{{{$image}}}" alt=""/></a>
												<div  class="gallery_main_qs product-image-thumb galerias">
													<a class="image-thumb active" src="{{ $image }}" data-image="{{ $image }}" data-zoom-image="{{ $image }}"><img width="100px" height="100px" src="{{ $image }}" alt=""/></a>
													<a class="image-thumb" src="{{ $image }}" data-image="{{ $image }}" data-zoom-image="{{ $image }}"><img width="100px" height="100px" src="{{ $image }}"></a>
													<a class="image-thumb active" src="{{ $image }}" data-image="{{ $image }}" data-zoom-image="{{ $image }}"><img width="100px" height="100px" src="{{ $image }}" alt=""/></a>
													<a class="image-thumb" src="{{ $image }}" data-image="{{ $image }}" data-zoom-image="{{ $image }}"><img width="100px" height="100px" src="{{ $image }}"></a>
													<a class="image-thumb active" src="{{ $image }}" data-image="{{ $image }}" data-zoom-image="{{ $image }}"><img width="100px" height="100px" src="{{ $image }}" alt=""/></a>
												...
												@php
													...
													$route = route("images","app/public/upload/shops/$image");
												@endphp
											<img width="270px" height="270px" src="{{ $route }}" class="img-responsive" alt="Donec aliquam ante non">
