...
@section('menu')
<body class="templetIndex notouch">
					...
					<div itemprop="breadcrumb" class="container">
						<div class="row">
							<div class="col-md-24">
								...
								<span class="page-title">{{{$shop->name}}}</span>
							</div>
              ...
              <div class="collection-warper col-sm-24 clearfix">
                <div class="collection-panner col-sm-6">
                  @php
  								...
  								@endphp
  								<img width="470px" height="320px" class="img-responsive" src="{{ $image }}">
                </div>
                <div class="container">
                  <div class="col-sm-6">
                    <div id="map" ></div>
                      ...
                      <div class="home_collections">
                        ...
                        <div class="home_products_wrapper">
                          <div id="home_products">
                            @foreach($shop->products as $i => $product)
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12 product-image">
                          ...
                          @php
													$image = route('images',"app/public/upload/shops/$shop->image")
                          @endphp
                          <a href="/sucursales/{{$shop->id}}"></a><img width="270px" height="270px" src="{{ $image }}" class="img-responsive" alt="Donec aliquam ante non">
                          </div>
                        </div>
...
<script>
      function initMap() {
        var uluru = {lat: {{{$shop->branches[0]->latitude}}}, lng: {{{$shop->branches[0]->longitude}}}};
