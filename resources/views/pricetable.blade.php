				...
				<section class="content">
					...
					<div class="container">
						<div class="row">
							...
							<div id="col-main" class="col-md-18 col-md-offset-6 normal-page clearfix">
								<div class="page ">
									<ul id="price-table">
										...
										<div class="pt-item-top">
											...
											<span class="pt-item-price">$0<span class="pt-item-small">Monto</span></span>
													<a href="/register"><button  class="btn btn-lg" type="submit">Registrate</button></a>
						...
						<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
										...
										<div class="pt-item-top">
											...
											<span class="pt-item-price">$100<span class="pt-item-small">monto</span></span>
													...
													<a href="/register"><button  class="btn btn-lg" type="submit" name="button">Registrate</button></a>
												<!--<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
												<input type="hidden" name="cmd" value="_s-xclick">
					...
					<footer id="footer">
							<div id="footer-content">
								<h6 class="general-title contact-footer-title">SOMOS TU MEJOR OPCIÓN!!!</h6>
