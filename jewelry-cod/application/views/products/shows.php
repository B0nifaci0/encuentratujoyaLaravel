...
<head>
  ...
  <title>Product Left Sidebar</title>
    ...
    <link href="http://localhost/goldandsilver/assets/stylesheets/font.css" rel='stylesheet' type='text/css'>

	<link href="http://localhost/goldandsilver/assets/stylesheets/font-awesome.min.css" rel="stylesheet" type="text/css" media="all">
	<link href="http://localhost/goldandsilver/assets/stylesheets/jquery.camera.css" rel="stylesheet" type="text/css" media="all">
	<link href="http://localhost/goldandsilver/assets/stylesheets/jquery.fancybox-buttons.css" rel="stylesheet" type="text/css" media="all">
	<link href="http://localhost/goldandsilver/assets/stylesheets/cs.animate.css" rel="stylesheet" type="text/css" media="all">
	<link href="http://localhost/goldandsilver/assets/stylesheets/application.css" rel="stylesheet" type="text/css" media="all">
	<link href="http://localhost/goldandsilver/assets/stylesheets/swatch.css" rel="stylesheet" type="text/css" media="all">
	<link href="http://localhost/goldandsilver/assets/stylesheets/jquery.owl.carousel.css" rel="stylesheet" type="text/css" media="all">
	<link href="http://localhost/goldandsilver/assets/stylesheets/jquery.bxslider.css" rel="stylesheet" type="text/css" media="all">
	<link href="http://localhost/goldandsilver/assets/stylesheets/bootstrap.min.3x.css" rel="stylesheet" type="text/css" media="all">
	<link href="http://localhost/goldandsilver/assets/stylesheets/cs.bootstrap.3x.css" rel="stylesheet" type="text/css" media="all">
	<link href="http://localhost/goldandsilver/assets/stylesheets/cs.global.css" rel="stylesheet" type="text/css" media="all">
	<link href="http://localhost/goldandsilver/assets/stylesheets/cs.style.css" rel="stylesheet" type="text/css" media="all">
	<link href="http://localhost/goldandsilver/assets/stylesheets/cs.media.3x.css" rel="stylesheet" type="text/css" media="all">
	<link href="http://localhost/goldandsilver/assets/stylesheets/spr.css" rel="stylesheet" type="text/css" media="all">
	<link href="http://localhost/goldandsilver/assets/stylesheets/addthis.css" rel="stylesheet" type="text/css" media="all">

	<script src="http://localhost/goldandsilver/assets/javascripts/jquery-1.9.1.min.js" type="text/javascript"></script>
	<script src="http://localhost/goldandsilver/assets/javascripts/jquery.imagesloaded.min.js" type="text/javascript"></script>
	<script src="http://localhost/goldandsilver/assets/javascripts/bootstrap.min.3x.js" type="text/javascript"></script>
	<script src="http://localhost/goldandsilver/assets/javascripts/jquery.easing.1.3.js" type="text/javascript"></script>
	<script src="http://localhost/goldandsilver/assets/javascripts/jquery.camera.min.js" type="text/javascript"></script>
	<script src="http://localhost/goldandsilver/assets/javascripts/jquery.mobile.customized.min.js" type="text/javascript"></script>
	<script src="http://localhost/goldandsilver/assets/javascripts/cookies.js" type="text/javascript"></script>
	<script src="http://localhost/goldandsilver/assets/javascripts/modernizr.js" type="text/javascript"></script>
	<script src="http://localhost/goldandsilver/assets/javascripts/application.js" type="text/javascript"></script>
	<script src="http://localhost/goldandsilver/assets/javascripts/jquery.owl.carousel.min.js" type="text/javascript"></script>
	<script src="http://localhost/goldandsilver/assets/javascripts/jquery.bxslider.js" type="text/javascript"></script>
	<script src="http://localhost/goldandsilver/assets/javascripts/skrollr.min.js" type="text/javascript"></script>
	<script src="http://localhost/goldandsilver/assets/javascripts/jquery.fancybox-buttons.js" type="text/javascript"></script>
	<script src="http://localhost/goldandsilver/assets/javascripts/jquery.zoom.js" type="text/javascript"></script>
	<script src="http://localhost/goldandsilver/assets/javascripts/cs.script.js" type="text/javascript"></script>
</head>
			  ...
			  <ul class="text-right">
				<li class="customer-links hidden-xs">
					<ul id="accounts" class="list-inline">
						<li class="my-account">
							<a href="http://localhost/goldandsilver/account.html">My Account</a>
						</li>
						<li class="login">
			...
			<div class="top-navigation">
				<ul class="list-inline">
					<li class="top-logo">
						...
						<img class="img-responsive" src="http://localhost/goldandsilver/assets/images/logo.png" alt="Jewelry - HTML Template theme">
						</a>
					</li>
					<li class="navigation">
						<nav class="navbar">
								...
								<div class="collapse navbar-collapse">
									<ul class="nav navbar-nav hoverMenuWrapper">
										...
										<div class="megamenu-container megamenu-container-2 dropdown-menu banner-right mega-col-2" style="display: none;">
											<ul class="sub-mega-menu">
												...
												<ul>
													...
													<li class="list-unstyled li-sub-mega">
													<a href="http://localhost/goldandsilver/about-us.html">About </a>
													</li>
													<li class="list-unstyled li-sub-mega">
										...
										<ul class="dropdown-menu">
											...
											<li class=""><a tabindex="-1" href="http://localhost/goldandsilver/article.html">Post full width</a></li>
											<li class=""><a tabindex="-1" href="http://localhost/goldandsilver/article-left.html"> Post - left sidebar</a></li>
											<li class="last"><a tabindex="-1" href="http://localhost/goldandsilver/article-right.html">Post - right sidebar</a></li>
										</ul>
										</li>
										<li class="nav-item">
										<a href="./contact.html">
										...
										<div class="items control-container">
											<div class="row items-wrapper">
												...
												<div class="col-md-8 cart-left">
													<a class="cart-image" href="./product.html"><img src="http://localhost/goldandsilver/assets/images/demo_77x77.png" alt="" title=""></a>
												</div>
							...
							<div class="left-slidebar col-xs-24 col-sm-6">
										<div class="group_sidebar">
																	...
																	<div class="element full_width fadeInUp animated" data-animate="fadeInUp" data-delay="0">
																		<form action="#" method="post">
																			<ul class="row-container list-unstyled clearfix">
																				...
																				<img src="http://localhost/goldandsilver/assets/images/demo_100x100.png" class="img-responsive" alt="Curabitur cursus dignis">
																				</a>
																				</li>
																	...
																	<div class="element full_width fadeInUp animated" data-animate="fadeInUp" data-delay="400">
																		<form action="#" method="post">
																			<ul class="row-container list-unstyled clearfix">
																				<li class="row-left">
																				<a href="./product.html" class="container_item">
																				<img src="http://localhost/goldandsilver/assets/images/demo_100x100.png" class="img-responsive" alt="Donec aliquam ante non">
																				</a>
																				</li>
																				<li class="row-right parent-fly animMix">
																	...
																	<div class="element full_width fadeInUp animated" data-animate="fadeInUp" data-delay="600">
																		<form action="#" method="post">
																			<ul class="row-container list-unstyled clearfix">
																				<li class="row-left">
																				<a href="./product.html" class="container_item">
																				<img src="http://localhost/goldandsilver/assets/images/demo_100x100.png" class="img-responsive" alt="Donec condime fermentum">
																				</a>
																				</li>
																				<li class="row-right parent-fly animMix">
											...
											<div class="sb-item slidebar-banner">
												...
												<div class="">
													<img src="http://localhost/goldandsilver/assets/images/demo_270x340.png" alt="">
												</div>
											</div>
											<!--End sb-item-->
									...
									<div id="product" class="content clearfix">
										<div id="product-image" class="product-image row no_full_width col-sm-12">
											<div class="image featured fadeInUp not-animated" data-animate="fadeInUp">
												<img src="http://localhost/goldandsilver/assets/images/demo_570x570.png" alt="Donec condime fermentum">
											</div>
											<div id="gallery_main" class="product-image-thumb thumbs mobile_full_width ">
												<ul style="opacity: 0; display: block;" class="slide-product-image owl-carousel owl-theme">
													<li class="image">
														<a href="http://localhost/goldandsilver/assets/images/demo_100x100.png" class="cloud-zoom-gallery active">
															<img src="http://localhost/goldandsilver/assets/images/demo_100x100.png" alt="Donec condime fermentum">
														</a>
													</li>
													<li class="image">
														<a href="http://localhost/goldandsilver/assets/images/demo_100x100.png" class="cloud-zoom-gallery">
															<img src="http://localhost/goldandsilver/assets/images/demo_100x100.png" alt="Donec condime fermentum">
														</a>
													</li>
													<li class="image">
											...
											<div id="product-header" class="clearfix">
												...
												<div id="product-info-right">
															...
															<div id="product-actions-1293235843" class="options clearfix">
																...
																<div class="swatch color clearfix" data-option-index="0">
																	...
																	<div data-value="black" class="swatch-element color black available">
																		...
																		<label for="swatch-0-black" style="background-color: black; background-image: url(http://localhost/goldandsilver/assets/images/black.png)">
																		<img class="crossed-out" src="http://localhost/goldandsilver/assets/images/soldout.png" alt="">
																		</label>
																	</div>
																	<div data-value="red" class="swatch-element color red available">
																		...
																		<label for="swatch-0-red" style="background-color: red; background-image: url(http://localhost/goldandsilver/assets/images/red.png)">
																		<img class="crossed-out" src="http://localhost/goldandsilver/assets/images/soldout.png" alt="">
																		</label>
																	</div>
																	<div data-value="white" class="swatch-element color white available">
																		...
																		<label for="swatch-0-white" style="background-color: white; background-image: url(http://localhost/goldandsilver/assets/images/white.png)">
																		<img class="crossed-out" src="http://localhost/goldandsilver/assets/images/soldout.png" alt="">
																		</label>
																	</div>
																	<div data-value="blue" class="swatch-element color blue available">
																		...
																		<label for="swatch-0-blue" style="background-color: blue; background-image: url(http://localhost/goldandsilver/assets/images/blue.png)">
																		<img class="crossed-out" src="http://localhost/goldandsilver/assets/images/soldout.png" alt="">
																		</label>
																	</div>
																</div>
																<div class="swatch clearfix" data-option-index="1">
																	...
																	<div data-value="small" class="swatch-element small available">
																		...
																		small <img class="crossed-out" src="http://localhost/goldandsilver/assets/images/soldout.png" alt="">
																		</label>
																	</div>
																	<div data-value="medium" class="swatch-element medium available">
																		<input id="swatch-1-medium" name="option-1" value="medium" type="radio">
																		<label for="swatch-1-medium">
																		medium <img class="crossed-out" src="http://localhost/goldandsilver/assets/images/soldout.png" alt="">
																		</label>
																	</div>
																</div>
													...
													<div id="pop-one" style="display: none;">
														<img src="http://localhost/goldandsilver/assets/images/demo_870x580.png" alt="">
													</div>
										...
										<div class="prod-related clearfix">
											<div class="element no_full_width not-animated" data-animate="bounceIn" data-delay="0">
												<ul class="row-container list-unstyled clearfix">
													<li class="row-left">
													<a href="./product.html" class="container_item">
													<img src="http://localhost/goldandsilver/assets/images/demo_270x270.png" class="img-responsive" alt="Curabitur cursus dignis">
													...
													<div class="hover-appear">
														...
														<a class="wish-list" href="http://localhost/goldandsilver/account.html" title="wish list"><i class="fa fa-heart"></i><span class="list-mode">Add to Wishlist</span></a>
													</div>
													</li>
												</ul>
											</div>
											...
											<div class="element no_full_width bounceIn not-animated" data-animate="bounceIn" data-delay="400">
												<ul class="row-container list-unstyled clearfix">
													<li class="row-left">
													<a href="./product.html" class="container_item">
													<img src="http://localhost/goldandsilver/assets/images/demo_270x270.png" class="img-responsive" alt="Donec aliquam ante non">
													<span class="sale_banner">
													<span class="sale_text">Sale</span>
													</span>
													</a>
											...
											<div class="element no_full_width bounceIn not-animated" data-animate="bounceIn" data-delay="600">
												<ul class="row-container list-unstyled clearfix">
													<li class="row-left">
													<a href="./product.html" class="container_item">
													<img src="http://localhost/goldandsilver/assets/images/demo_270x270.png" class="img-responsive" alt="Donec condime fermentum">
													</a>
													<div class="hbw">
														<span class="hoverBorderWrapper"></span>
													</div>
											...
											<div class="element no_full_width bounceIn not-animated" data-animate="bounceIn" data-delay="800">
												<ul class="row-container list-unstyled clearfix">
													<li class="row-left">
													<a href="./product.html" class="container_item">
													<img src="http://localhost/goldandsilver/assets/images/demo_270x270.png" class="img-responsive" alt="Maximus quam posuere">
													<span class="sale_banner">
													<span class="sale_text">Sale</span>
													</span>
													</a>
											...
											<div class="element no_full_width not-animated" data-animate="bounceIn" data-delay="1000">
												<ul class="row-container list-unstyled clearfix">
													<li class="row-left">
													<a href="./product.html" class="container_item">
													<img src="http://localhost/goldandsilver/assets/images/demo_270x270.png" class="img-responsive" alt="Product full width">
													<span class="sale_banner">
													<span class="sale_text">Sale</span>
													</span>
													</a>
				...
				<div class="container">
					  ...
					  <div class="group">
						...
						<ul class="list-unstyled list-styled">
						  <li class="list-unstyled">
							<a href="http://localhost/goldandsilver/account.html">Store Locations</a>
						  </li>
						  <li class="list-unstyled">
							<a href="http://localhost/goldandsilver/account.html">Whosesalers</a>
						  </li>
						  <li class="list-unstyled">
							<a href="http://localhost/goldandsilver/account.html">Map Site</a>
						  </li>
						  <li class="list-unstyled">
							<a href="http://localhost/goldandsilver/account.html">Contact Us</a>
						  </li>
						</ul>
					  </div>
					</div>
					<div class="footer-link-list col-md-6">
					  <div class="group">
						...
						<ul class="list-unstyled list-styled">
						  <li class="list-unstyled">
							<a href="http://localhost/goldandsilver/account.html">Help &amp; FAQs</a>
						  </li>
						  <li class="list-unstyled">
							<a href="http://localhost/goldandsilver/account.html">Advance Search</a>
						  </li>
						  <li class="list-unstyled">
							<a href="http://localhost/goldandsilver/account.html">Gift Cards</a>
						  </li>
						  <li class="list-unstyled">
							<a href="http://localhost/goldandsilver/account.html">Shop By Brands</a>
						  </li>
						</ul>
					  </div>
					</div>
					<div class="footer-link-list col-md-6">
					  <div class="group">
						...
						<ul class="list-unstyled list-styled">
						  <li class="list-unstyled">
							<a href="http://localhost/goldandsilver/account.html">Preferences</a>
						  </li>
						  <li class="list-unstyled">
							<a href="http://localhost/goldandsilver/account.html">Order History</a>
						  </li>
						  <li class="list-unstyled">
							<a href="http://localhost/goldandsilver/account.html">Cart Page</a>
						  </li>
						  <li class="list-unstyled">
							<a href="http://localhost/goldandsilver/account.html">Sign In</a>
						  </li>
						</ul>
					  </div>
					</div>
			...
			<div class="footer-content footer-content-bottom clearfix">
				<div class="container">
					<div class="copyright col-md-12">
						© 2015 <a href="http://localhost/goldandsilver/about-us.html">Jewelry - HTML template</a>. All Rights Reserved.
					</div>
