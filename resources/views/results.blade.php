												...
												<li class="element first no_full_width" data-alpha="Curabitur cursus dignis" data-price="25900">
													<ul class="row-container list-unstyled clearfix">
														<li class="row-left">
															...
															@endphp
														<a href="{{ $image }}" class="container_item">
						...
						<div class="col-md-12 product-image">
							<div  class="quick-shop-image product-image-wrapper">
								...
								<div id="gallery_main_qs" class="product-image-thumb">
									<a class="image-thumb active" href="./assets/1images/demo_79x79.png" data-image="{{ $image }}" data-zoom-image="{{ $image }}"><img src="{{ $image }}" alt=""/></a>
									<a class="image-thumb" href="{{ $image }}" data-image="{{ $image }}" data-zoom-image="{{ $image }}"><img src="{{ $image }}" alt=""/></a>
									<a class="image-thumb" href="{{ $image }}" data-image="{{ $image }}" data-zoom-image="{{ $image }}"><img src="{{ $image }}" alt=""/></a>
									<a class="image-thumb" href="{{ $image }}" data-image="{{ $image }}" data-zoom-image="{{ $image }}"><img src="{{ $image }}" alt=""/></a>
									<a class="image-thumb" href="{{ $image }}" data-image="{{ $image }}" data-zoom-image="{{ $image }}"><img src="{{ $image }}" alt=""/></a>
									<a class="image-thumb" href="{{ $image }}" data-image="{{ $image }}" data-zoom-image="{{ $image }}"><img src="{{ $image }}" alt=""/></a>
