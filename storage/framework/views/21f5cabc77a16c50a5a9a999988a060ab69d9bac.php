				...
				<section class="content">
					<div class="container">
                        ...
                        $image = route('images',"app/public/upload/products/$product->image")
                         ?>
												<img src="<?php echo e($image); ?>" class="img-responsive" alt="Donec condime fermentum">
											</div>
											<div id="gallery_main" class="product-image-thumb thumbs mobile_full_width ">
												<ul style="opacity: 0; display: block;" class="slide-product-image owl-carousel owl-theme">
													<li class="image">
														<a src="<?php echo e($image); ?>" class="img-responsive" class="cloud-zoom-gallery active">
															<img src="<?php echo e($image); ?>" class="img-responsive" alt="Donec condime fermentum">
														</a>
													</li>
													<li class="image">
														<a src="<?php echo e($image); ?>" class="img-responsive" class="cloud-zoom-gallery">
															<img src="<?php echo e($image); ?>" class="img-responsive" alt="Donec condime fermentum">
														</a>
													</li>
													<li class="image">
                              ...
                              <?php echo e($product->description); ?>
													...
													<div class="relative">
														<ul class="list-unstyled">
															<li class="tags">
															<span>Peso : <?php echo e($product->weigth); ?></span>
															<a href="#">
															<?php echo e($product->price); ?><span>,</span>
															</a>
															<a href="#">
															<?php echo e($product->purity); ?><span>,</span>
															</a>
															<a href="#">
															<?php echo e($product->nationality); ?><span>,</span>
															</a>
