...
<header id="top" class="clearfix">
  ...
  <div class="container">
    ...
    <div class="col-md-6 phone-shopping">
      <span>Telefono de compra (722) 6-57-57-09</span>
    </div>
    <div class="col-md-18">
      <ul class="text-right">
        ...
        <ul id="accounts" class="list-inline">
          ...
          <li class="login">
            <span id="loginButton" class="dropdown-toggle" data-toggle="dropdown">
              <a href="http://www.jewelrypalace.site/users/login">Iniciar sesión</a>
              <i class="sub-dropdown1"></i>
              <i class="sub-dropdown"></i>
            </span>
            <!-- Customer Account Login -->
            <div id="loginBox" class="dropdown-menu text-left">
            <form method="post" action="<?= URL ?>users/login" id="customer_login" accept-charset="UTF-8"><input type="hidden" value="customer_login" name="form_type"><input type="hidden" name="utf8" value="✓">
              <div id="bodyBox">
                <ul class="control-container customer-accounts list-unstyled">
                  <li class="clearfix">
                    <label for="customer_email_box" class="control-label">Correo electronico<span class="req">*</span></label>
                    <input type="email" name="email" id="customer_email_box" class="form-control">
                  </li>
                  <li class="clearfix">
                    <label for="customer_password_box" class="control-label">Contraseña<span class="req">*</span></label>
                    <input type="password" name="password" id="customer_password_box" class="form-control password">
                  </li>
                  <li class="clearfix">
                    <button class="action btn btn-1" type="submit">Iniciar</button>
                  </li>
                  <li class="clearfix">
                    <a class="action btn btn-1" href="<?= URL ?>users/registry">Registrate</a>
                  </li>
                </ul>
              </div>
            </form>
          ...
          <li>/</li>
          <li class="register">
            <a href="http://www.jewelrypalace.site/Users/registry" id="customer_register_link">Crear cuenta</a>
          </li>
        </ul>
      </li>
      <li id="widget-social">
        <ul class="list-inline">
        <li><a target="_blank" href="#" class="btooltip swing" data-toggle="tooltip" data-placement="		bottom" title="" data-original-title="Facebook"><i class="fa fa-facebook"></i></a>
        </li>
        <li><a target="_blank" href="#" class="btooltip swing" data-toggle="tooltip" data-placement="		bottom" title="" data-original-title="Twitter"><i class="fa fa-twitter"></i></a>
        </li>
        <li><a target="_blank" href="#" class="btooltip swing" data-toggle="tooltip" data-placement="		bottom" title="" data-original-title="Instagram"><i class="fa fa-instagram"></i></a>
        </li>
        </ul>
      </li>
      </ul>
  ...
  <div class="container">
    <div class="top-navigation">
      <ul class="list-inline">
        <li class="top-logo">
          <a id="site-title" href="http://www.jewelrypalace.site" title="Gold and Silver">
          <img class="img-responsive" src="http://www.jewelrypalace.site/assets/images/logo.png" alt="Jewelry - HTML Template theme">
          </a>
        </li>
        <li class="navigation">
          <nav class="navbar">
                ...
                <ul class="list-inline">
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="customer dropdown-menu">
                      ...
                      <a href="http://www.jewelrypalace.site/users/registry">Registrate</a>
                      </li>
                    </ul>
                  </div>
                  </li>
                ...
                <ul class="nav navbar-nav hoverMenuWrapper">
                  ...
                  <div class="megamenu-container megamenu-container-1 dropdown-menu banner-bottom mega-col-4" style="">
                    <ul class="sub-mega-menu">
                      <li>
                      <ul>
                        <li class="list-title">Compromiso</li>
                      ...
                      <li>
                      <ul>
                        <li class="list-title">Hombre</li>
                        <li class="list-unstyled li-sub-mega">
                        <a href="#">Anillos</a>
                        </li>
                        <li class="list-unstyled li-sub-mega">
                        <a href="#">Cadenas<span class="megamenu-label new-label">Nuevo</span>
                        </a>
                        </li>
                        <li class="list-unstyled li-sub-mega">
                        <a href="#">Relojes</a>
                      ...
                      <ul>
                        ...
                        <li class="list-unstyled li-sub-mega">
                        <a href="#">Tiaras<span class="megamenu-label sale-label">Oferta</span>
                        </a>
                        </li>
                      ...
                      <li>
                      <ul>
                        <li class="list-title">Novedades</li>
                        <li class="list-unstyled li-sub-mega">
                        <a href="#">Ejemplo<span class="megamenu-label new-label">New</span>
                        </a>
                        </li>
                        <li class="list-unstyled li-sub-mega">
                        <a href="#">Ejemplo</a>
                        ...
                        <li class="list-unstyled li-sub-mega">
                        <a href="./product.html">Ejemplo</a>
                        </li>
                        <li class="list-unstyled li-sub-mega last">
                        <a href="./product.html">Ejemplo<span class="megamenu-label hot-label">Hot</span>
                        </a>
                        </li>
                      </ul>
                      </li>
        ...
        <li class="top-search hidden-xs">
          <div class="header-search">
            ...
            <!--<form id="header-search" class="search-form dropdown-menu" action="search.html" method="post">
            ...
            <div class="cart-link">
              ...
              <div id="cart-info" class="dropdown-menu" style="display: none;">
                <div id="cart-content">
                  ...
                  <div class="action">
                    <button class="btn" onclick="window.location='./cart.html'">Terminar compra</button><a class="btn btn-1" href="./cart.html">Ver Carrito</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <li class="mobile-search visible-xs">
          <!--<form id="mobile-search" class="search-form" action="search.html" method="post">
            <input type="hidden" name="type" value="product">
